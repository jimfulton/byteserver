...
use in a byteserver.  It is similar in functionality to a `ZODB
storage
...
writing and reading data transactionally.  Other features, like pack (segments) and
replication will be added over time.
...
- When a transaction is begun, a temporary file will be fetched from a
